    ...
    <div className="w-full relative">
      ...
      >
        ...
        <button
          ...
          className="w-12 h-12 rounded-xl flex items-center justify-center text-foreground disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"
        >
          {isProcessing ? (
